...
(1..12).each do |i|
  projects = Project.create :title => "Test Project #{i}", :nav_name => "Test Project #{i}", :active => true, :market => markets.first, :categories => [ categories.first,  categories[rand(categories.size)] ]
end
