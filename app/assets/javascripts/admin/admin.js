...
$(document).ready(function(){
  ...
  $('form.edit_asset').live('ajax:success', function(evt, data, status, xhr) {
    $('#notifications').append('<div class="flash success">Update successfully saved.</div>');
    $('#notifications').children('div:last').delay(5000).fadeOut();
  });
  ...
  $('select#markets').change(function(){
    ...
    window.location = $(this).val()=='' ? root : root + '?market_filter=' + $(this).val();
  });
